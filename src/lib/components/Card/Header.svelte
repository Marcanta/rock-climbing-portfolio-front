<div class="flex flex-row justify-between items-center pr-2">
    <div class="flex flex-row">
        <img src="profile_image.png" class="rounded-full w-10 h-10 object-cover"/>
        <div class="flex flex-col mx-2 mt-1">
            <p class="text-sm font-bold">Camila</p>
            <p class="text-xs font-semibold text-gray-400">Mexico City, Mexico</p>
        </div>
    </div>
